...
import 'package:absensi/app/modules/aktivitas/controllers/aktivitas_controller.dart';
import 'package:absensi/app/modules/lembur/controllers/lembur_controller.dart';
import 'package:absensi/app/modules/permit/controllers/permit_controller.dart';
...
class CalenderController extends GetxController {
  ...
  void getPermit() async {
    final respose = await http.get(Uri.parse(BaseUrl.getMasterPermit));
  ...
  void simpanLembur(BuildContext context) async {
    ...
    if (jamawal.text == "") {
      Get.snackbar("Warning", "kolom jam awal wajib di isi",
    ...
    if (jamakhir.text == "") {
      Get.snackbar("Warning", "kolom jam akhir wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    if (selamatext.text == "") {
      Get.snackbar("Warning", "kolom Selama wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    if (lemburext.text == "") {
      Get.snackbar("Warning", "kolom keterangan wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    final response = await http.post(Uri.parse(BaseUrl.inputLembur), body: {
      "nik": box.read('nik'),
    ...
    if (data['value'] == 1) {
      ...
      Get.snackbar("Warning", "Proses anda gagal. ",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
    }
  ...
  void simpanPermit(BuildContext context) async {
    ...
    if (tglawal.text == "") {
      Get.snackbar("Warning", "kolom tgl awal wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    if (tglakhir.text == "") {
      Get.snackbar("Warning", "kolom tgl akhir wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    final response = await http.post(Uri.parse(BaseUrl.inputPermit), body: {
      "nik": box.read('nik'),
  ...
  void simpanAktivitas(BuildContext context) async {
    ...
    if (aktivitas.text == "") {
      Get.snackbar("Warning", "kolom aktivitas wajib di isi",
          colorText: Colors.white,
          backgroundColor: Color.fromARGB(255, 235, 61, 61),
          snackPosition: SnackPosition.TOP);
      return;
    ...
    final response = await http.post(Uri.parse(BaseUrl.inputAktivitas), body: {
